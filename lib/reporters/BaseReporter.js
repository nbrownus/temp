var runnables = require('../runnables')
  , RUN_STATE = require('../Constants').RUN_STATE
    ...
    pocha.on('runnable finish', function (runnable) {
        if (runnable instanceof runnables.Test) {
            ...
            switch (runnable.state) {
                ...
                case RUN_STATE.TIMEOUT:
                case RUN_STATE.FAILURE:
                    self.failures.push(runnable)
                    self.stats.failures++
                    break

                case RUN_STATE.SKIPPED:
                    self.stats.skipped++
                    break

                case RUN_STATE.HOOK_FAILURE:
                    //TODO
                    break
        ...
        //TODO: Need to report all runnable failures
    })
