...
var Runnable = function (title, func) {
    ...
    this.timedOut = false
    //TODO: This needs to specified or inherited
    this._timeout = 2000
 ...
 *
 * @param {Array.<Runnable>} dependencies Array of runnables that are dependencies
 */
Runnable.prototype.addRunnableDependants = function (dependencies) {
    if (!dependencies) {
        return
    }

    dependencies = (Array.isArray(dependencies)) ? dependencies : [dependencies]
    this.runnableDependencies = this.runnableDependencies.concat(dependencies)
}
...
Runnable.prototype.run = function () {
    if (this._completedDependencies < this.dependencies.length) {
        return
    }
