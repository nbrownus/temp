...
Pocha.prototype.run = function () {
    ...
    var startNode = new RootNode('Start')
      , finishNode = new RootNode('Finish')

    startNode.globallyExclusive()
    finishNode.globallyExclusive()
    self.addRunnable(startNode)

    //TODO: Make this configurable
    self.rootSuite.locallyExclusiveTests()
    self.rootSuite.prepare([startNode])

    finishNode.addDependencies(self.getEdges())
    self.addRunnable(finishNode)
