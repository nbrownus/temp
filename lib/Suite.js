 ...
 * @returns {Suite} This for chaining
 */
Suite.prototype.globallyExclusiveRunnables = function () {
 ...
 * @returns {Suite} This for chaining
 */
Suite.prototype.locallyExclusiveRunnables = function () {
 ...
 * @returns {Suite} This for chaining
 */
Suite.prototype.nonExclusiveRunnables = function () {
    this.testExclusivity = EXCLUSIVITY.NONE
    return this
}

/**
 * Getter/setter Marks this suite and all runnables underneath it as the only things that should run
...
/**
 * Getter/setter default timeout for suites and runnables under this suite
 *
 ...
 *
 * @returns {Suite|Boolean} This for chaining if setting, whether or not this is runnable will be skipped if getting
 */
...
Suite.prototype.prepare = function () {
    ...
    if (self.runnables.beforeAll.length) {
        self.runnables.beforeAll.forEach(function (runnable) {
            ...
            runnable.addDependencies(self.runnableDependencies)
            self.runnableDependencies.push(runnable)
        })
...
Suite.prototype._prepareSuites = function (suites) {
    ...
    suites.forEach(function (suite) {
        if (!suite.only() && !suite.skip()) {
            suite.skip(self._skip || self._hasOnlyTest)
        }
        ...
        suite.runnableDependencies = self.runnableDependencies.slice()
...
Suite.prototype._setRunnableProperties = function (runnable) {
    ...
    if (!runnable.only() && !runnable.skip()) {
        runnable.skip(self._skip || self._hasOnlyTest)
    }
