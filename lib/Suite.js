...
Suite.prototype.nextDependencies = function (dependencies) {
    if (this.parent) {
        this.parent.nextDependencies(dependencies)
    }
...
Suite.prototype._createTestContainer = function (runnable) {
    ...
    suite.exclusivity = runnable.exclusivity
    suite.parent = self
...
Suite.prototype._completePrep = function () {
    ...
    console.log('PREPARED', self.title)
    self.emit('prepared')
}
